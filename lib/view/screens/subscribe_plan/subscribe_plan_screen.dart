                              ...
                              itemBuilder: (context, index) {
                                ...
                                return InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: controller.isBuyPlanClick &&
                                            controller.sIndex == index
                                        ? const Center(
                                            child: CircularProgressIndicator(
                                            valueColor:
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  HeaderText(
                                                    text:
                                                        '${controller.planList[index].duration ?? ''} ${MyStrings.days.tr}',
                                                    textStyle:
                                                        mulishBold.copyWith(
                                                            color: MyColor
                                                                .colorWhite
                                                  ...
                                                  Text(
                                                    '${CustomValueConverter.twoDecimalPlaceFixedWithoutRounding(controller.planList[index].pricing ?? '0')} ₹',
