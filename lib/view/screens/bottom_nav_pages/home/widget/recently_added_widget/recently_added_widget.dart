                ...
                child: Row(
                  children: List.generate(
                    ...
                    (index) => GestureDetector(
                      onTap: () {
                        bool isFree =
                            controller.recentlyAddedList[index].version == '0'
                                ? true
                                : false;
                        bool isPaidUser =
                            controller.homeRepo.apiClient.isPaidUser();
                        if (controller.isGuest() && !isFree) {
                          ...
                          Get.toNamed(RouteHelper.movieDetailsScreen,
                              arguments: [
                                controller.recentlyAddedList[index].id,
                                -1
                              ]);
                        }
                      },
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              controller.recentlyAddedList[index].title?.tr ??
                                  '',
