    ...
    return GetBuilder<OnboardingController>(
      builder: (controller) => controller.isLoading
        ...
        itemBuilder: (context, index) {
          String imageUrl;
          if (index == 0) {
            imageUrl = controller.bgImageUrl;
          } else if (index == 1) {
            imageUrl = controller.bgImage2Url;
          } else if (index == 2) {
            imageUrl = controller.bgImage3Url;
          } else
            imageUrl = '';
          ...
          return Scaffold(
            ...
            body: SizedBox(
              ...
              child: Stack(
                children: [
                  BgImageWidget(bgImage: imageUrl), // Pass the respective image URL
                  Padding(
