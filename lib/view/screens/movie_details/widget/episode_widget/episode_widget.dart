...
class _EpisodeWidgetState extends State<EpisodeWidget> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<MovieDetailsController>(builder: (controller) {
      int episodeLength = controller.movieDetails.data?.episodes != null
          ? controller.movieDetails.data!.episodes!.length
          : 0;
                    ...
                    children: [
                      ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            print('KKK  ${UrlContainer.baseUrl}${controller.episodePath2}${controller.episodeList[index].image ?? ''}');
                            return InkWell(
                              ...
                              onTap: () {
                                ...
                                try {
                                  itemId = int.parse(
                                      controller.episodeList[index].itemId ??
                                          '-1');
                                } catch (e) {
                                  e.printError();
                                }
                                Get.offAndToNamed(
                                    ...
                                    arguments: [
                                      itemId,
                                      controller.episodeList[index].id ?? -1
                                    ]);
                              },
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: CustomNetworkImage(
                                              ...
                                              height: 120,
                                              imageUrl:
                                              '${UrlContainer.baseUrl}${controller.episodePath2}${controller.episodeList[index].image ?? ''}'),
                                        ),
                                        Positioned(
                                            top: 8,
                                            right: 8,
                                    ...
                                    const SizedBox(
                                      height:
                                      Dimensions.spaceBetweenTextAndImage,
                                    ),
                                    const SizedBox(
                                      width: 20,
                                    ),
