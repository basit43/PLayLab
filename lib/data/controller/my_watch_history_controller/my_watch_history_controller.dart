...
class MyWatchHistoryController extends GetxController implements GetxService{
  ...
  void fetchInitialList() async {
    ...
    try {
      ...
      String url = '${UrlContainer.baseUrl}${UrlContainer
          .watchHistoryEndPoint}?page=$page';
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse.isNotEmpty && jsonResponse['status'] == 'success') {
          WatchHistoryResponseModel watchHistoryResponseModel = WatchHistoryResponseModel
              .fromJson(jsonResponse);
          List<Data>?tempHistoryList = watchHistoryResponseModel.data?.histories
              ?.data;
          nextPageUrl = watchHistoryResponseModel.data?.histories?.nextPageUrl;
